...
document.addEventListener('DOMContentLoaded', function() {
	...
	const firstRunButton = document.querySelector('.button_first-run');
	const restartButton = document.querySelector('.button_restar');
	...
	const createConfetti = () => {
		...
		for (let i = 0; i < countConfettiItems; i++) {
	  	...
	  	const confettiItem = document.querySelector('.confetti__item');
	...
	const closeBtnMainNav = document.querySelector('.btn-close_main-nav');
